...
$id ? ($sql .= "AND p.id = $id") : $sql .= "LIMIT 2";
...
<body>
    ...
    <section class="container mt-5">
        ...
        <div class="row mx-0 row-cols-1 row-cols-lg-3 row-cols-xl-4">

            <?php foreach ($retrievedData as $key => $property) : ?>
                <div class="col p-1">
                    <div class="card h-100 shadow">
                        <div class="position-relative">
                            <a href="<?php echo 'properties.php?id=' . $property['id']; ?>">
                            ...
                            <span class="badge bg-warning position-absolute bottom-0 end-0 me-3 text-dark fw-light">
                                <?php echo $property['enlisted_for'] == 'Both'
                                    ? 'Rent & Lease'
                                    : $property['enlisted_for']; ?>
                            </span>
                        </div>
                        <div class="card-body">
                            <a href="<?php echo 'properties.php?id=' . $property['id']; ?>" class="text-decoration-none">
                            ...
                            <div class="d-block" style="font-size: 0.9rem;">
                                ...
                                <div>
                                    ...
                                    <span class="text-secondary">
                                        <?php echo $property['district']; ?>,&nbsp;<?php echo $property['division']; ?>
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer">
                            ...
                            <div class="d-flex flex-wrap justify-content-around">
                                <?php foreach ([
                                    ...
                                    echo $property[$amenityName]
                                        ? //? printing icons if amenity values are not null
                                        ($amenityName != 'ac_type'
                                            ? "<span 
            ...
            <div class="col p-2 d-flex justify-content-center align-items-center">
                <div class="d-flex justify-content-center align-items-center bf-blur hvr-grow w-75 border rounded shadow" style="min-height: 12rem;" onclick="(async () => {
                    await fetch('api/app/fetch/loadmoreproperties.php', { method: 'GET' , headers: { 'content-type' : 'application/json', 'offset': '11'} }) 
